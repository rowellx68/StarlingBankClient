...
namespace StarlingBankClient.Models
{
    public class StringValuedEnumConverter : JsonConverter
    {
        ...
        {
            var enumHelperType = LoadEnumHelperType(value.GetType());
            var enumHelperMethod = enumHelperType.GetRuntimeMethod("ToValue", new[] { value.GetType() });
            var stringValue = enumHelperMethod.Invoke(null, new[] { value });
            if (stringValue != null)
        ...
        private static Type LoadEnumHelperType(Type enumType)
        {
            ...
            var assembly = isNullableGeneric ? Nullable.GetUnderlyingType(enumType).GetTypeInfo().Assembly : enumType.GetTypeInfo().Assembly;
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            try
            {
                if (reader.TokenType == JsonToken.String)
                {
                    ...
                    var enumHelperType = LoadEnumHelperType(objectType);
